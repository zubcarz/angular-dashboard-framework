...
Visual_HorasHombreIndirectas widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-Visual_HorasHombreIndirectas
...
```html
<script type="text/javascript" src="path/to/Visual_HorasHombreIndirectas.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.Visual_HorasHombreIndirectas']);
```
