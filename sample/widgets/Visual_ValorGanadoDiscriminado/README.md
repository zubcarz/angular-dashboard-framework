# adf-widget-VISUAL_ValorGanadoDiscriminado

VISUAL_ValorGanadoDiscriminado widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-VISUAL_ValorGanadoDiscriminado
...
```html
<script type="text/javascript" src="path/to/VISUAL_ValorGanadoDiscriminado.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.VISUAL_ValorGanadoDiscriminado']);
```
