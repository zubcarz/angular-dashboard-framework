# adf-widget-Visual_ValorGanado

Visual_ValorGanado widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-Visual_ValorGanado
...
```html
<script type="text/javascript" src="path/to/Visual_ValorGanado.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.Visual_ValorGanado']);
```
